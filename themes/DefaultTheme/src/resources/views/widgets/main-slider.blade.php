...
<div class="row index-main-slider px-2 py-3 gap-2 gap-lg-0 d-flex justify-content-start {{ $widget->option('banner_position', 'left') == 'right' ? 'flex-row-reverse' : '' }}">
    ...
    <div class="col-lg-8 col-md-12 order-1 m-0">
        ...
        @if ($main_sliders->count())
            <section id="main-slider" class="main-slider h-100 main-slider-cs m-0 carousel slide carousel-fade card d-none d-md-block " data-ride="carousel">
        ...
        @if ($mobile_sliders->count())
            <section id="main-slider-res" class="main-slider carousel slide carousel-fade card d-block d-md-none mx-0" data-ride="carousel">
                <ol class="carousel-indicators">
