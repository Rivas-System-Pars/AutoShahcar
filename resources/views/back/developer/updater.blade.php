                            ...
                            <ul class="activity-timeline timeline-left list-unstyled">
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-small-3">- امکان خروجی گرفتن از لیست خودروها و لیست سفارشات به صورت پیشرفته</p>
                                        <p class="font-small-3">- اضافه شدن فیلم آموزش ایجاد خودرو</p>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-small-3">- اضافه شدن امکان برچسب گذاری خودروها</p>
                                        <p class="font-small-3">- اضافه شدن ابزارک نوشته های وبلاگ در صفحه اصلی</p>
                                        <p class="font-small-3">- بهبود ظاهری برخی از قسمت ها</p>
                                        <p class="font-small-3">- امکان اضافه کردن به سبد خرید از صفحه اصلی برای خودروها تک قیمته</p>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-small-3">- اضافه شدن قسمت ارزها و فروش خودرو بر اساس نرخ ارز مثل (دلار، یورو و....)</p>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-small-3">- مرتب سازی خودروها براساس  جدیدترین، پربازدیدترین،  پرفروش ترین، ارزان ترین و گران ترین در صفحه دسته بندی</p>
                                        <p class="font-small-3">- رفع برخی از باگ ها</p>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-small-3">- اضافه شدن نمودار قیمت برای خودروها</p>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-small-3">- اضافه شدن بخش خودرو دانلودی</p>
                                        <p class="font-small-3">- بهبود صفحه لیست قیمت ها</p>
                                        <p class="font-small-3">- اضافه شدن صفحه  لیست خودروها منتظر ارسال</p>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-small-3">- دیتاتیبل برای لیست خودروها</p>
                                        <p class="font-small-3">- رفع باگ های جزئی</p>
                                        <p class="font-small-3">- حذف محدودیت قیمت برای خودروها</p>
                                        <p class="font-small-3">- افزودن فیلد دسته بندی ها برای خودرو</p>
                                        <p class="font-small-3">- نمایش بهتر فیلد دسته بندی در ایجاد خودرو</p>
