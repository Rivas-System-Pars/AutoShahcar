                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">ویرایش خودرو
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card overflow-hidden">
                                <div class="card-header">
                                    <h4 class="card-title">اطلاعات خودرو "{{ $product->title }}"</h4>
                                </div>
                                            ...
                                            <ul class="nav nav-tabs nav-left flex-column" role="tablist">
                                                ...
                                                <li class="nav-item physical-item">
                                                    <a class="nav-link" id="product-prices-tab-nav" data-toggle="tab"
                                                        ...
                                                        role="tab" aria-selected="false">ویژگی</a>
                                                </li>
                                                                    ...
                                                                    <div class="col-md-3 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ $product->publish_in_index }}">
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                ...
                                                <div class="tab-pane" id="product-prices-tab" role="tabpanel"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="card-body" >
                                                            ...
                                                            <div class="row prices-option-div" hidden>
                                                                ...
                                                                @foreach ($gift->products as $product)
                                                                    <div class="d-flex">
                                                                        <button type="button"
                                                                            ...
                                                                            <i
                                                                                class="vs-icon feather text-danger icon-x-circle"></i>
                                                                        </button>
