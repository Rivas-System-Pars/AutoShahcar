<script id="prices-template" type="text/x-custom-template">
    <div class="row animated fadeIn single-price">
        ...
        <div class="col-md-3 col-12">
            <div class="form-group">
                <label>قیمت</label>
                <input type="number" data-unit="تومان" class="form-control amount-input price" name="price" value="1000" required>
            </div>
        </div>
        ...
        <div class="col-md-3 col-12">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="stock" min="0" value="1000" required>
            </div>
        </div>
        <div class="col-md-3 col-12">
            <div class="form-group">
