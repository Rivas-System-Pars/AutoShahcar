...
// ------------------ Admin Part Routes
Route::group(['as' => 'admin.', 'prefix' => 'admin/' . admin_route_prefix(), 'middleware' => ['auth', 'Admin', 'verified', 'CheckPasswordChange', 'password.confirm','UserOfferCheck']], function () {
	...
	Route::resource('demo-request', DemoRequestController::class)->only(['index','show']);
